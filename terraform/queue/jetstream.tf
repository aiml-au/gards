provider "jetstream" {
  servers = "nats://${data.terraform_remote_state.app.outputs.nats_host}:4222"
}

# TODO: Deduplicate this file somehow with the one in the queue/init directory.
# -- They get deployed to different environments. Maybe this is a use case for terragrunt.
